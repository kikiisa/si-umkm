@extends('backend.layouts.master', ['title' => 'Slider'])
@section('content')
                                ...
                                <tbody>
                                    @foreach ($data as $x)
                                        <tr>
                                            ...
                                            <td>{{$x->judul}}</td>
                                            <td><img src="{{asset('data/slider/'.$x->image)}}" width="90"></td>
                                            <td>
                                                <form action="{{Route('slider.destroy', $x->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{Route('slider.edit', $x->uuid)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Slider</h1>
                    ...
                    <div class="modal-body">
                        <form action="{{ Route('slider.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="judul" placeholder="Slider" class="form-control">
                            </div>
                            <div class="form-group mb-3">
